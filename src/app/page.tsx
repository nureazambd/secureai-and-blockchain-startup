...
image editing, and ensuring complete data security for all users.</p>
            ...
            <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                ...
                <div className="sm:block hidden">
                    ...
                    <p className="font-normal text-base leading-6 text-gray-600 mt-6">secure AI project development, decentralized data management, generative AI for social media automation and image editing, and ensuring complete data security for all users.</p>
                </div>
            </div>
