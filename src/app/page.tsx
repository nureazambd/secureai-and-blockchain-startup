          ...
          <div className="container mx-auto py-9 md:py-12 lg:py-14 ">
            <div className="relative bg-black">
              ...
              <div className="absolute z-10 top-0 left-0 mx-4 sm:mx-0 mt-36 sm:mt-0 sm:py-20 md:py-28 lg:py-20 xl:py-28 sm:pl-14 flex flex-col sm:justify-start items-start">
                <h1 className="text-xl sm:text-2xl lg:text-4xl xl:text-6xl font-semibold text-gray-800 sm:w-8/12">
                  Secure Intelligent AI and Blockchain Startup
                </h1>
                <p className="text-base leading-normal text-gray-800 mt-4 sm:mt-5 sm:w-5/12">
                  This white paper presents the vision, strategy, and
                  technological foundation of Secure Intelligent, our AI and
                  blockchain startup dedicated to delivering highly secure,
                  decentralized AI-driven solutions.{" "}
                </p>
        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 bg-gray-100">
          ...
          <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
            <div className="w-full lg:w-6/12">
              <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 text-gray-800 leading-9">
                Our mission is to utilize decentralized cloud storage, advanced
                Large Language Models (LLMs) named{" "}
                <samp className=" text-orange-500">Hura</samp>, and a native
                cryptocurrency,{" "}
                <span className=" text-orange-500">HalalCoin</span>
              </h2>
              <p className="font-normal text-base leading-6 text-gray-600 mt-6">
                to create an innovative platform for AI applications. Key
                features include secure AI project development, decentralized
                data management, generative AI for social media automation, a
                decentralized AI chatbot, and image editing, all while ensuring
                complete data security for all users. Our approach ensures
                transparency, certification, and privacy across all interactions
                on the platform.
              </p>
            </div>
            <div className="w-full lg:w-6/12">
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
            <div>
              ...
              <p className="font-normal text-base leading-6 text-gray-600 mt-6">
                Our vision is to build a world where AI technologies are secure,
                decentralized, and transparent, enabling users to harness the
                full potential of AI while maintaining complete control and
            ...
            <div>
              ...
              <p className="font-normal text-base leading-6 text-gray-600 mt-6">
                Our mission is to create a completely decentralized and secure
                AI system using advanced technologies, such as the Hura LLM and
                blockchain, combined with a transparent and certified native
                cryptocurrency, HalalCoin. We are committed to offering secure
                AI project development, data management, and a platform that
                guarantees data integrity, privacy, and transparency for all
                users.
              </p>
            </div>
            <div className="sm:block hidden">
              ...
              <p className="font-normal text-base leading-6 text-gray-600 mt-6">
                secure AI project development, decentralized data management,
                generative AI for social media automation and image editing, and
                ensuring complete data security for all users.
              </p>
            </div>
          </div>
          ...
          <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
            <div className="w-full lg:w-6/12">
              ...
              <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
                The rapid evolution of AI and blockchain technologies has
                created unprecedented opportunities for innovation across
                multiple sectors. However, these advancements also present
                significant challenges, especially in terms of data security,
                privacy, and centralized control. Secure Intelligent aims to
                tackle these issues by developing a decentralized AI platform
                that integrates cutting-edge technologies to provide secure,
                scalable, and efficient solutions.{" "}
              </p>
              <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">
                Our platform is designed to ensure that all data interactions
                are transparent, fully decentralized, and securely managed,
                reflecting the core principles of trust and user empowerment.
              </p>
            </div>
            <div className="w-full lg:w-6/12">
